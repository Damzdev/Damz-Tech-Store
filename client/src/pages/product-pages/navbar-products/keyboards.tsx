...
import img1 from '../../../assets/product-banners/keyboards_banner.png'
...
export default function Keyboards() {
	const {
		...
		isLoading,
		isError,
	} = useQuery<ProductType[]>('keyboards', async () => {
	...
	return (
		<div className="bg-white py-8 px-4 md:px-8 lg:px-12">
			...
			<h1 className="text-3xl font-bold text-center my-8 text-transparent bg-gradient-to-r from-blue-400 via-blue-300 to-white bg-clip-text ">
