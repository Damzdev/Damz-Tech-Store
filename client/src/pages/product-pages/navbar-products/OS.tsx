...
import img1 from '../../../assets/product-banners/operating-system-online-banner-2560px-v1.png'
...
export default function OperatingSystem() {
	...
	return (
		<div className="bg-white py-8 px-4 md:px-8 lg:px-12">
			...
			<h1 className="text-3xl font-bold text-center py-8 text-transparent bg-gradient-to-r from-orange-500 via-orange-600 to-red-600 bg-clip-text ">
