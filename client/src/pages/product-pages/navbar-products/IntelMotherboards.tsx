...
import img1 from '../../../assets/product-banners/intel-motherboards-banners-2560px-v1.png'
...
export default function IntelMotherboards() {
	const {
		data: products,
		isLoading,
		isError,
	} = useQuery<ProductType[]>(['intel', 'intel-motherboards'], async () => {
		const response = await axios.get<ProductType[]>(
			'http://localhost:3005/api/components/intel-motherboards'
		)
	...
	return (
		<div className="bg-white py-8 px-4 md:px-8 lg:px-12">
			...
			<h1 className="text-3xl font-bold text-center my-8 text-transparent bg-gradient-to-r from-purple-600 via-indigo-600 to-cyan-400 bg-clip-text ">
				Best Intel Motherboards Available
			</h1>
