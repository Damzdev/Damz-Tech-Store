...
import img1 from '../../../assets/product-banners/power-supply-banner-2560px-v01.png'
...
export default function PowerSupplys() {
	const {
		data: products,
		isLoading,
		isError,
	} = useQuery<ProductType[]>('power-supply', async () => {
		const response = await axios.get<ProductType[]>(
			'http://localhost:3005/api/components/power-supplys'
		)
