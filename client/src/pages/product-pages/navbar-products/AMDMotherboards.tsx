...
import img1 from '../../../assets/product-banners/amd-mb-banner.png'
...
export default function AMDMotherboards() {
	const {
		data: products,
		isLoading,
		isError,
	} = useQuery<ProductType[]>('AMD-motherboards', async () => {
		const response = await axios.get<ProductType[]>(
			'http://localhost:3005/api/components/amd-motherboards'
		)
	...
	return (
		<div className="bg-white py-8 px-4 md:px-8 lg:px-12">
			...
			<h1 className="text-3xl font-bold text-center my-8 text-transparent bg-gradient-to-r from-orange-500 via-orange-600 to-red-600 bg-clip-text ">
				Best AMD Motherboards Available
			</h1>
