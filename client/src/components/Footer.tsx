...
export default function Footer() {
	return (
		<>
			<footer className="text-white bg-footerbg m-0 p-5 sm:pt-10">
				<div className="flex flex-col items-center sm:flex-row sm:justify-between sm:items-start sm:pl-24">
					...
					<div className="flex flex-col items-center sm:mr-12">
						...
						<div className="flex flex-col items-center sm:items-start pl-14 pr-12">
							...
							<div className="flex items-center">
								<img className="w-5 mr-2" src={email} alt="Email" />
								<p>support@damztech.co.za</p>
							</div>
						</div>
					</div>
				</div>
				<div className="bg-footerbg text-white text-center p-12 w-full">
